#!/usr/bin/env python3
"""
NOTE: 미사용 사본. 정본은 ~/dogany/dev-agent/routines/onboarding-check.py 이며
settings.json(SessionStart) 양쪽 모두 그 정본을 호출한다. 이 파일은 stale 방지용으로
정본과 동일하게 유지만 한다(직접 호출되지 않음).
